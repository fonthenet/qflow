...
// Kept in sync with apps/web/src/lib/wilayas.ts and apps/desktop/src/lib/wilayas.ts
// so every surface (web kiosk, station, mobile) shows the exact same picker.
