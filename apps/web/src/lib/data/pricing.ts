...
export const plans: Plan[] = [
  {
    ...
    price: 0,
    yearlyPrice: 0,
    description: 'Best for proving the workflow in one location',
    cta: 'Get Started Free',
    limits: { customersPerMonth: 50, locations: 1, staff: 2 },
    features: [
      'Up to 50 monthly visits',
      '1 location',
      '2 staff members',
      'QR code check-in',
  ...
  },
  {
    ...
    price: 19,
    yearlyPrice: 15,
    description: 'For small teams running daily service operations',
    cta: 'Start Free Trial',
    limits: { customersPerMonth: 500, locations: 1, staff: 5 },
    features: [
      'Up to 500 monthly visits',
      '1 location',
      '5 staff members',
  ...
  },
  {
    ...
    price: 49,
    yearlyPrice: 39,
    description: 'For growing businesses with multiple services or sites',
    highlight: true,
    cta: 'Start Free Trial',
    limits: { customersPerMonth: 2000, locations: 3, staff: 15 },
    features: [
      'Up to 2,000 monthly visits',
      '3 locations',
      '15 staff members',
  ...
  },
  {
    ...
    price: 99,
    yearlyPrice: 79,
    description: 'For established operators standardizing service across teams',
    cta: 'Start Free Trial',
  ...
  },
  {
    ...
    price: 199,
    yearlyPrice: 159,
    description: 'For larger organizations with procurement and integration needs',
    cta: 'Contact Sales',
...
export const featureComparison: PlanFeature[] = [
  { name: 'Visits per month', free: '50', starter: '500', growth: '2,000', pro: '10,000', enterprise: 'Unlimited' },
  ...
  { name: 'Real-time visit updates', free: true, starter: true, growth: true, pro: true, enterprise: true },
  ...
  { name: 'Visit intake forms', free: false, starter: true, growth: true, pro: true, enterprise: true },
  { name: 'Appointment scheduling', free: false, starter: false, growth: true, pro: true, enterprise: true },
  { name: 'Remote join', free: false, starter: false, growth: true, pro: true, enterprise: true },
