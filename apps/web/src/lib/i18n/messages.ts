...
export const messages: Record<AppLocale, Record<string, string>> = {
  ...
  fr: {
    ...
    'Being Served': 'Prise en charge',
    'Get ready!': 'Préparez-vous !',
    'Almost there!': 'Presque votre tour !',
    '{count} Ahead': '{count} devant vous',
    'Wait': 'Attente',
    ...
    'Cancel the entire recurring series? This will cancel all upcoming appointments in this series.': 'Annuler toute la série récurrente ? Cela annulera tous les rendez-vous à venir de cette série.',
    'Cancel Series': 'Annuler la série',
    '{count} appointments cancelled': '{count} rendez-vous annulés',
    ...
    'Permanently delete appointment for {name}? This cannot be undone.': 'Supprimer définitivement le rendez-vous de {name} ? Cette action est irréversible.',
    ...
    'Cancel appointment': 'Annuler le rendez-vous',
    'Cancel entire series': 'Annuler toute la série',
    'Delete appointment permanently': 'Supprimer le rendez-vous définitivement',
    ...
    'Recurring': 'Récurrent',
    // ── Payment methods (BYO) — FR ──
    'Payment options': 'Options de paiement',
    'Pay online': 'Payer en ligne',
    'Bank transfer': 'Virement bancaire',
    'Mobile money': 'Mobile money',
    'Scan to pay': 'Scanner pour payer',
    'Cash accepted': 'Espèces acceptées',
    'IBAN': 'IBAN',
    'SWIFT/BIC': 'SWIFT/BIC',
    'RIB': 'RIB',
    ...
    'Reply QR to get codes': 'Répondre QR pour obtenir les codes',
    'Download QR': 'Télécharger le QR',
    'Enable': 'Activer',
    'Disable': 'Désactiver',
    'Payment Methods': 'Modes de paiement',
    'Reorder payment methods by dragging.': 'Réorganisez les modes de paiement par glisser-déposer.',
  },
  ar: {
    ...
    'In Queue': 'في الطابور',
    'Being Served': 'تتم خدمتك',
    'Get ready!': 'استعد!',
    'Almost there!': 'اقترب دورك!',
    '{count} Ahead': 'أمامك {count}',
    'Wait': 'الانتظار',
    ...
    'Cancel the entire recurring series? This will cancel all upcoming appointments in this series.': 'هل تريد إلغاء السلسلة المتكررة بالكامل؟ سيتم إلغاء جميع المواعيد القادمة في هذه السلسلة.',
    'Cancel Series': 'إلغاء السلسلة',
    '{count} appointments cancelled': 'تم إلغاء {count} مواعيد',
    'Delete Appointment': 'حذف الموعد',
    'Permanently delete appointment for {name}?': 'حذف موعد {name} نهائياً؟',
    'Permanently delete appointment for {name}? This cannot be undone.': 'حذف موعد {name} نهائياً؟ لا يمكن التراجع عن هذا الإجراء.',
    ...
    'Deleting...': 'جاري الحذف...',
    'Cancel appointment': 'إلغاء الموعد',
    'Cancel entire series': 'إلغاء السلسلة بالكامل',
    'Delete appointment permanently': 'حذف الموعد نهائياً',
...
Object.assign(messages.ar, {
  ...
  'Step {step} of {total}': 'الخطوة {step} من {total}',
    ...
    'No payment methods configured.': 'لم يتم تكوين أي طريقة دفع.',
    'Reply QR to get codes': 'أرد بـ QR للحصول على الرموز',
    'Download QR': 'تنزيل رمز QR',
    'Enable': 'تمكين',
    'Disable': 'تعطيل',
    'Payment Methods': 'طرق الدفع',
    'Reorder payment methods by dragging.': 'أعد ترتيب طرق الدفع عن طريق السحب.',
});
