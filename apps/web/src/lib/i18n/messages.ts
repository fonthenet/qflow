...
export const messages: Record<AppLocale, Record<string, string>> = {
  ...
  fr: {
    ...
    'This {label} already has an active ticket. Finish service or send the current ticket back to the queue first.':
      'Ce {label} a déjà un ticket actif. Terminez le service ou remettez d’abord le ticket actuel dans la file.',
    'Finish service or send the current ticket back to the queue first.':
      'Terminez le service ou remettez d’abord le ticket actuel dans la file.',
    ...
    'Add a mobile number if you want guaranteed text backup alerts for urgent queue updates.':
      'Ajoutez un numéro de mobile si vous voulez des alertes SMS de secours garanties pour les mises à jour urgentes de la file.',
    ...
    'This business requires email verification before customers can join the queue.':
      'Cette entreprise exige une vérification e-mail avant qu’un client puisse rejoindre la file.',
    ...
    'Email verified. You can join the queue now.': 'E-mail vérifié. Vous pouvez maintenant rejoindre la file.',
    ...
    'Joining Queue...': 'Connexion à la file...',
    ...
    'Buzz': 'Buzz',
    'No Show': 'Absent',
    'Reset to Queue': 'Remettre dans la file',
    ...
    "After joining, you'll receive a ticket to track your position. You can wait anywhere and come when it's almost your turn.":
      'Après avoir rejoint la file, vous recevrez un ticket pour suivre votre position. Vous pouvez attendre n’importe où et venir quand votre tour approche.',
