...
export const industryTemplates: IndustryTemplate[] = [
  {
    ...
    defaultNavigation: ['/admin/overview', '/admin/onboarding', '/admin/offices', '/admin/departments', '/admin/services', '/admin/desks', '/admin/priorities', '/admin/displays', '/admin/kiosk', '/admin/calendar', '/admin/bookings', '/admin/analytics', '/admin/settings', '/desk'],
  ...
  },
  {
    ...
    dashboardMode: 'bank',
    defaultNavigation: ['/admin/overview', '/admin/onboarding', '/admin/offices', '/admin/services', '/admin/desks', '/admin/staff', '/admin/analytics', '/admin/customers', '/admin/calendar', '/admin/bookings', '/admin/displays', '/admin/settings', '/desk'],
  ...
  },
  {
    ...
    defaultNavigation: ['/admin/overview', '/admin/onboarding', '/admin/offices', '/admin/departments', '/admin/services', '/admin/staff', '/admin/priorities', '/admin/analytics', '/admin/calendar', '/admin/bookings', '/admin/kiosk', '/admin/settings', '/desk'],
  ...
  },
  {
    ...
    defaultNavigation: ['/admin/overview', '/admin/onboarding', '/admin/offices', '/admin/services', '/admin/desks', '/admin/staff', '/admin/calendar', '/admin/bookings', '/admin/analytics', '/admin/customers', '/admin/settings', '/desk'],
  ...
  },
  {
    ...
    dashboardMode: 'light_service',
    defaultNavigation: ['/admin/overview', '/admin/onboarding', '/admin/offices', '/admin/services', '/admin/staff', '/admin/analytics', '/admin/customers', '/admin/calendar', '/admin/bookings', '/admin/settings', '/desk'],
