  ...
  return (
    <div className="flex h-screen">
      ...
      <main className="flex-1 overflow-y-auto bg-background p-6">
        {!wizardCompleted && (staff.role === 'admin' || staff.role === 'manager') ? (
          <div className="mb-6 rounded-2xl border border-blue-200 bg-blue-50 px-5 py-4 text-sm text-blue-900 flex items-center justify-between">
            <div>
              <p className="font-semibold text-foreground">{t('Finish your business setup')}</p>
              <p className="mt-1">
                {t('Pick your business type and configure offices, desks, and staff. Takes a few minutes.')}
              </p>
            </div>
            <a
