  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Display Screens</h1>
      ...
      {showCreateForm && (
        <section className="rounded-xl border border-primary/30 bg-card p-6 space-y-4">
          <h2 className="text-lg font-semibold text-foreground">Create New Display Screen</h2>
          ...
          {screens.map((screen) => (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Office: {getOfficeName(screen.office_id)}
              </p>
        ...
        <div className="space-y-6 p-6">
          ...
          <section className="space-y-3">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-foreground">Show Clock</span>
            </label>
          </section>
          ...
          <section className="space-y-3">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="h-4 w-4 rounded border-border text-primary focus:ring-primary/50"
              />
              <span className="text-sm text-foreground">Show &quot;Next Up&quot; queue list</span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="h-4 w-4 rounded border-border text-primary focus:ring-primary/50"
              />
              <span className="text-sm text-foreground">Show department breakdown</span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="h-4 w-4 rounded border-border text-primary focus:ring-primary/50"
              />
              <span className="text-sm text-foreground">Show estimated wait times</span>
            </label>
          ...
          <section className="space-y-3">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="h-4 w-4 rounded border-border text-primary focus:ring-primary/50"
              />
              <span className="text-sm text-foreground">Play announcement sound</span>
            </label>
          ...
          {/* Department Filter */}
          <section className="space-y-3">
            <h3 className="text-sm font-semibold text-foreground">Visible Departments</h3>
