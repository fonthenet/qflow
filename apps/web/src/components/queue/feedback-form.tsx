    ...
    return (
      <>
        ...
        <QueueStopDialog
          ...
          isStopping={isFinishing}
          title="Finish this visit?"
          description="We’ll clear this completed visit from this device and stop any leftover alerts."
  ...
  return (
    <>
      <div className="flex min-h-screen flex-col bg-[radial-gradient(circle_at_top,_rgba(34,197,94,0.18),_transparent_40%),linear-gradient(180deg,_#020617_0%,_#0f172a_100%)]">
        <div className="mx-auto flex w-full max-w-md flex-1 flex-col px-4 py-8">
            ...
            <form onSubmit={handleSubmit} className="mt-8">
              ...
              <div className="mt-6 grid gap-3">
                ...
                <button
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-6 py-4 text-sm font-semibold text-slate-100 transition hover:bg-white/8"
                >
          ...
          <div className="mt-auto pt-6 text-center">
            <p className="text-xs uppercase tracking-[0.28em] text-slate-500">{serviceName} · QueueFlow</p>
          </div>
        </div>
      </div>
      ...
      <QueueStopDialog
        isOpen={showFinishDialog}
        isStopping={isFinishing}
        title="Finish without feedback?"
        description="We’ll clear this visit from this device now. You can still reopen the ticket later if you need to."
        confirmLabel="Finish visit"
        onCancel={() => setShowFinishDialog(false)}
        onConfirm={() => void handleFinish()}
      />
